...
class BfOAAlgorithmRepository(AlgorithmRepository):
    def prepare(self, agent_length, fitness, lower_bound, upper_bound, phase_1_max_iter, phase_2_max_iter, N, is_maximizing=False):
        self.agent_length = agent_length
        self.fitness_function = fitness
        self.lower_bound = lower_bound
        self.upper_bound = upper_bound
        self.max_iter = phase_1_max_iter
        self.is_maximizing = is_maximizing
        self.N = N
        self.n_plane = 8
        self.population = []
        self.phase_1_max_iteration = phase_1_max_iter
        self.phase_2_max_iteration = phase_2_max_iter
    ...
    def run(self):
        # return [random.random() for i in range(ll)]
        # start phase 1
        # print('start phase 1')
